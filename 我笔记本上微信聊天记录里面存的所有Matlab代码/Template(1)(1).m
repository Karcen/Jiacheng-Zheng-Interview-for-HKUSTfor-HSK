...
PAK=[PAK.DVA.FIN PAK.DVA.INT PAK.FVA.FIN PAK.FVA.INT PAK.VAXG PAK.TE];
% csvwrite('E:\China_vs_India\PAK\Wang\1996\PAK.csv',PAK)  

% Define your header as a cell array of strings
header = {'DVAFIN', 'DVAINT', 'FVAFIN', 'FVAINT', 'VAXG', 'TE'}; % Adjust according to your actual column names
% Convert header to a comma-separated string
headerStr = strjoin(header, ',');
% Define the filename
filename = 'E:\China_vs_India\PAK\Wang\1996\PAK1996.csv';
...
% Close the file
fclose(fid);
% Append the data to the file using dlmwrite
dlmwrite(filename, PAK, '-append');
